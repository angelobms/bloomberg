...
import com.bloomberg.calculatorapi.web.errors.ErrorMessage;
import com.bloomberg.calculatorapi.web.errors.ErrorMessages;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleOilConflictException(DivisionByZeroException ex, WebRequest request) {
        return buildResponseEntity(ErrorCode.DIVISION_BY_ZERO, HttpStatus.BAD_REQUEST, request);
    }

    @ExceptionHandler(value = ResourceNotFoundException.class)
    public ResponseEntity<?> handleResourceNotFoundException(ResourceNotFoundException ex, WebRequest request) {
        return buildResponseEntity(ErrorCode.RESOURCE_NOT_FOUND, HttpStatus.NOT_FOUND, request, ex.getId());
    }
