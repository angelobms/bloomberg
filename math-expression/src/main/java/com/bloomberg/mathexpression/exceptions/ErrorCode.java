...
public interface ErrorCode {
    ...
    String ENUM_VALIDATION = "error.default.enumValidation.message";
    ...
    String ENUM_OPERATION_TYPE = "error.enumOperationType.message";
    String DIVISION_BY_ZERO = "error.divisionByZero.message";
}
